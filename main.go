...
func main() {
	...
	flagSet.Var(&skipAuthHeader, "skip-auth-header", "bypass authentication if header matches (regular expression, e.g. ^X-Real-IP: 192\\..+$) (may be given multiple times)")
